...
class AvatarConfigResponse(BaseModel):
    ...
    default_colors: List[str] = Field(..., description="The color palette for autogenerated avatars")
    max_size: int = Field(..., description="Maximum allowed dimension for avatars (width/height)")
    max_file_size: int = Field(..., description="Maximum allowed file size in bytes")
    allowed_types: List[str] = Field(..., description="List of allowed MIME types for avatars")
