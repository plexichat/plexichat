...
class OAuthMixin:
    ...
    def oauth_login(
            ...
            if email:
                ...
                if user_row:
                    ...
                    self._db.insert_or_ignore(  # pyright: ignore[reportAttributeAccessIssue]
                        ...
                        (
                            self._generate_id(),  # pyright: ignore[reportAttributeAccessIssue]
                            user_id,
                            provider,
                            external_id,
                            email_index,
        ...
        if not user_id:
            ...
            attempts = 0
            while attempts < 10 and self._db.fetch_one(  # pyright: ignore[reportAttributeAccessIssue]
            ...
            try:
                user = self.register(  # pyright: ignore[reportAttributeAccessIssue]
                    username=username,
                ...
                email_index = self.crypto.blind_index(  # pyright: ignore[reportAttributeAccessIssue]
        ...
        user_obj = self.get_user(user_id)  # pyright: ignore[reportAttributeAccessIssue]
        if not user_obj:
        ...
        session = self._create_session(user_id, None, ip_address, user_agent)  # pyright: ignore[reportAttributeAccessIssue]
