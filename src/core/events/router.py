...
EVENT_INTENT_MAP = {
    ...
    EventType.ARTIFACT_CREATE: GatewayIntent.ARTIFACTS,
    EventType.ARTIFACT_UPDATE: GatewayIntent.ARTIFACTS,
    EventType.ARTIFACT_DELETE: GatewayIntent.ARTIFACTS,
    EventType.ARTIFACT_OP: GatewayIntent.ARTIFACTS,
}
