...
def get_conversations(
    ...
    """
    return _get_manager().get_conversations(user_id, limit, before_id, conversation_type)
...
def update_conversation(
    ...
    return _get_manager().update_conversation(user_id, conversation_id, name, max_participants)
...
def add_participant(
    ...
    return _get_manager().add_participant(user_id, conversation_id, participant_id, role)
...
def update_participant_role(
    ...
    return _get_manager().update_participant_role(user_id, conversation_id, participant_id, role)
...
def get_messages(
    ...
    """
    return _get_manager().get_messages(user_id, conversation_id, limit, before_id, after_id)
...
def mark_read(user_id: int, conversation_id: int, up_to_message_id: Optional[int] = None) -> int:
    """
...
def get_unread_count(user_id: int, conversation_id: Optional[int] = None) -> Dict[int, int]:
    """
...
def send_system_message(
    ...
    return _get_manager().send_system_message(conversation_id, content, event_type, metadata)
