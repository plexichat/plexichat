...
class TestSQLInjection:
    ...
    def test_sql_injection_in_login_username(self, test_client):
        ...
        for payload in payloads:
            ...
            assert response.status_code == 401, f"SQL injection payload should be rejected: {payload}"
    ...
    def test_sql_injection_in_message_content(self, test_client, modules, create_user_with_token):
...
class TestCommandInjection:
    ...
    def test_command_injection_in_server_name(self, test_client, create_user_with_token):
...
class TestLDAPInjection:
    ...
    def test_ldap_injection_in_username(self, test_client):
        ...
        for payload in payloads:
            ...
            assert response.status_code == 401, f"LDAP injection should be rejected: {payload}"
