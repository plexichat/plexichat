...
class TestExemptions:
    ...
    def test_role_exemption(self, automod_module, test_server_for_automod, modules, user_pool):
    ...
    def test_global_exemption(self, automod_module, test_server_for_automod, modules, user_pool):
