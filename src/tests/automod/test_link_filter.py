...
class TestInviteLinkRule:
    ...
    def test_blocks_invite_code(
        ...
        automod_module.create_rule(
            ...
            rule_config={"block_all": True, "code_length": 8},
    ...
    def test_allows_whitelisted_codes(
        self, automod_module, test_server_for_automod, user_pool, modules
    ):
        ...
        automod_module.create_rule(
            ...
            rule_type=RuleType.INVITE_LINKS,
            rule_config={"block_all": True, "allowed_codes": ["allowed1"]},
            actions=[{"action_type": "delete_message"}],
        )
...
class TestExternalLinkRule:
    ...
    def test_whitelisted_domain_passes(
        self, automod_module, test_server_for_automod, user_pool, modules
    ):
        ...
        automod_module.create_rule(
            ...
            name="Whitelist Links",
            rule_type=RuleType.EXTERNAL_LINKS,
            rule_config={"mode": "whitelist", "whitelist": ["github.com"]},
            actions=[{"action_type": "delete_message"}],
        )
    ...
    def test_subdomain_matching(
        ...
        automod_module.create_rule(
            ...
            name="Block Domain",
            rule_type=RuleType.EXTERNAL_LINKS,
            rule_config={"mode": "blacklist", "blacklist": ["evil.com"]},
            actions=[{"action_type": "delete_message"}],
        )
...
class TestLinkRuleValidation:
    ...
    def test_valid_invite_config(self):
        ...
        valid, issues = InviteLinkRule.validate_config(
            {"block_all": True, "allowed_codes": ["abc123"]}
        )
    ...
    def test_valid_external_config(self):
        ...
        valid, issues = ExternalLinkRule.validate_config(
            {"mode": "blacklist", "blacklist": ["bad.com"]}
        )
    ...
    def test_invalid_mode(self):
        ...
        valid, issues = ExternalLinkRule.validate_config({"mode": "invalid"})
