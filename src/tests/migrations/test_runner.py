...
class TestMigrationRunner:
    ...
    def test_execute_migration_up_requires_up_function(self, test_db, temp_migrations_dir):
    ...
    def test_execute_migration_down_requires_down_function(self, test_db, migration_without_down):
