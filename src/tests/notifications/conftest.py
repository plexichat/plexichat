...
def test_env():
    ...
    test_dir = "temp_notifications_test"
...
def db_and_modules(test_env, request):
    ...
    notifications._setup_complete = False
    notifications.setup(db, messaging, servers, relationships, presence)

    yield db, auth, messaging, servers, relationships, presence, notifications
...
def base_users(db_and_modules):
    ...
    return user1, user2, user3, auth, messaging, servers, relationships, presence, notifications


@pytest.fixture
def users_with_dm(base_users):
    """Create users with a DM conversation."""
    user1, user2, user3, auth, messaging, servers, relationships, presence, notifications = base_users

    dm = messaging.create_dm(user1.id, user2.id)

    return user1, user2, dm, messaging, notifications
...
def fresh_users(db_and_modules):
    ...
    return user1, user2, auth, messaging, servers, relationships, presence, notifications
...
def users_with_server(db_and_modules):
    ...
    return owner, member1, member2, server, channel, servers, messaging, notifications
...
@pytest.fixture
def group_conversation(db_and_modules):
    ...
    return owner, member1, member2, group, messaging, notifications, relationships
