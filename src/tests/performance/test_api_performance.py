...
class TestAPIEndpointPerformance:
    ...
    def test_get_messages_endpoint_performance(self, benchmark, api_client, modules, test_dm):
    ...
    def test_send_message_endpoint_performance(self, benchmark, api_client, modules, test_dm):
...
class TestAPIThroughput:
    ...
    def test_sustained_request_throughput(self, api_client, modules, test_dm):
        ...
        assert throughput > 50, f"Throughput too low: {throughput:.1f} req/s (expected > 50 req/s)"
    ...
    def test_read_heavy_throughput(self, api_client, modules, test_dm):
        ...
        assert throughput > 100, f"Read throughput too low: {throughput:.1f} req/s (expected > 100 req/s)"
    ...
    def test_mixed_workload_throughput(self, api_client, modules, test_dm):
        ...
        assert throughput > 60, f"Mixed throughput too low: {throughput:.1f} req/s (expected > 60 req/s)"


class TestAPIMemory:
    """Test API memory usage and leaks."""

    def test_request_handling_memory_leak(self, api_client, modules, test_dm, memory_tracker):
