...
class TestSetStatus:
    ...
    def test_set_status_online(self, fresh_users):
        ...
        result = presence_manager.set_status(user1.id, UserStatus.ONLINE)
    ...
    def test_set_status_idle(self, fresh_users):
        ...
        result = presence_manager.set_status(user1.id, UserStatus.IDLE)
    ...
    def test_set_status_dnd(self, fresh_users):
        ...
        result = presence_manager.set_status(user1.id, UserStatus.DND)
    ...
    def test_set_status_invisible(self, fresh_users):
        ...
        result = presence_manager.set_status(user1.id, UserStatus.INVISIBLE)
    ...
    def test_set_status_offline(self, fresh_users):
        ...
        result = presence_manager.set_status(user1.id, UserStatus.OFFLINE)
...
class TestGetStatus:
    ...
    def test_get_status_after_set(self, fresh_users):
        ...
        presence_manager.set_status(user1.id, UserStatus.ONLINE)
        status = presence_manager.get_status(user1.id)
    ...
    def test_get_status_default_offline(self, fresh_users):
        ...
        status = presence_manager.get_status(user2.id)
...
class TestClearStatus:
    ...
    def test_clear_status_sets_offline(self, fresh_users):
        ...
        presence_manager.set_status(user1.id, UserStatus.ONLINE)
        result = presence_manager.clear_status(user1.id)
...
class TestCustomStatus:
    ...
    def test_set_custom_status_text_only(self, fresh_users):
        ...
        result = presence_manager.set_custom_status(user1.id, "Working on a project")
    ...
    def test_set_custom_status_with_emoji(self, fresh_users):
        ...
        result = presence_manager.set_custom_status(
            user1.id, "Coding", emoji=":computer:"
        )
    ...
    def test_set_custom_status_with_expiration(self, fresh_users):
        ...
        result = presence_manager.set_custom_status(
            user1.id, "BRB", expires_at=expires_at
        )
    ...
    def test_get_custom_status(self, fresh_users):
        ...
        presence_manager.set_custom_status(user1.id, "Testing")
        custom = presence_manager.get_custom_status(user1.id)
    ...
    def test_get_custom_status_none(self, fresh_users):
        ...
        custom = presence_manager.get_custom_status(user2.id)
    ...
    def test_clear_custom_status(self, fresh_users):
        ...
        presence_manager.set_custom_status(user1.id, "Testing")
        result = presence_manager.clear_custom_status(user1.id)
    ...
    def test_update_custom_status(self, fresh_users):
        ...
        presence_manager.set_custom_status(user1.id, "First status")
        result = presence_manager.set_custom_status(user1.id, "Updated status")
    ...
    def test_custom_status_created_at(self, fresh_users):
        ...
        result = presence_manager.set_custom_status(user1.id, "Testing")
