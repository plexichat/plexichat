...
class TestReactionErrors:
    ...
    def test_reaction_unique_per_user(self, reaction_manager, test_db, monkeypatch):
        ...
        monkeypatch.setitem(reaction_manager._config, "max_unique_reactions_per_user", 1)
    ...
    def test_remove_all_reactions_permission(self, reaction_manager, test_db):
        ...
        test_db.execute("INSERT INTO msg_conversations (id, conversation_type, created_at, updated_at) VALUES (1, 'dm', 1000, 1000)")
        test_db.execute("INSERT INTO msg_participants (id, conversation_id, user_id, role, joined_at) VALUES (1, 1, 1, 'owner', 1000), (2, 1, 2, 'member', 1000)")
        test_db.execute("INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'test', 1000, 1000, 'text')")
...
class TestReactionBulkOperations:
    ...
    def test_get_reactions_for_multiple_messages(self, reaction_manager, test_db):
        ...
        test_db.execute("INSERT INTO msg_conversations (id, conversation_type, created_at, updated_at) VALUES (1, 'dm', 1000, 1000)")
        test_db.execute("INSERT INTO msg_participants (id, conversation_id, user_id, role, joined_at) VALUES (1, 1, 1, 'member', 1000)")
        test_db.execute("INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'test1', 1000, 1000, 'text'), (2, 1, 1, 'test2', 1000, 1000, 'text')")
