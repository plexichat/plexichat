"""
Shared fixtures for relationship tests.
"""
...
def db_and_modules(test_env, request):
    """Setup database, auth, servers, and relationships once per test module."""
    import gc
    ...
    yield db, auth, servers, relationships
...
def base_users(db_and_modules):
    ...
    return user1, user2, user3, user4, auth, servers, relationships


@pytest.fixture
def users(base_users):
    """Get test users."""
    user1, user2, user3, user4, auth, servers, relationships = base_users
    return user1, user2, user3, user4, relationships
...
def fresh_users(db_and_modules):
    ...
    return user1, user2, relationships
...
def users_with_server(db_and_modules):
    ...
    return user1, user2, user3, server, servers, relationships
