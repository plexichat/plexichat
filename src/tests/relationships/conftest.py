...
def db_and_modules(modules):
    ...
    return modules._db, modules.auth, modules.servers, modules.relationships
...
def users(modules, user_pool):
    ...
    return user1, user2, user3, user4, modules.relationships
...
def users_with_server(modules):
    ...
    return user1, user2, user3, server, modules.servers, modules.relationships
