...
class TestSearchErrors:
    ...
    def test_search_messages(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO auth_users (id, username, account_type, password_hash, permissions, created_at, updated_at) VALUES (1, 'testuser', 'user', 'hash', '{}', 1000, 1000)"
        )
        test_db.execute(
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'hello world', 1000, 1000, 'text')"
        )

        search_manager.index_message(
            1, "hello world", {"author_id": 1, "conversation_id": 1, "created_at": 1000}
        )
    ...
    def test_search_users(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO auth_users (id, username, account_type, password_hash, permissions, created_at, updated_at, email_verified) VALUES (1001, 'testuser', 'user', 'hash', '{}', 1000, 1000, 1)"
        )
    ...
    def test_search_servers(self, search_manager, test_db):
        """Search servers."""
        test_db.execute(
            "INSERT INTO srv_servers (id, name, owner_id, created_at, updated_at) VALUES (1, 'Test Server', 1, 1000, 1000)"
        )
        test_db.execute(
    ...
    def test_search_with_author_filter(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO auth_users (id, username, account_type, password_hash, permissions, created_at, updated_at) VALUES (1, 'user1', 'user', 'hash', '{}', 1000, 1000), (2, 'user2', 'user', 'hash', '{}', 1000, 1000)"
        )
        test_db.execute(
            "INSERT INTO msg_conversations (id, conversation_type, created_at, updated_at) VALUES (1, 'dm', 1000, 1000)"
        )
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'hello', 1000, 1000, 'text'), (2, 1, 2, 'hello', 1000, 1000, 'text')"
        )

        search_manager.index_message(
            1, "hello", {"author_id": 1, "conversation_id": 1, "created_at": 1000}
        )
        search_manager.index_message(
            2, "hello", {"author_id": 2, "conversation_id": 1, "created_at": 1000}
        )
    ...
    def test_search_pagination(self, search_manager, test_db):
        ...
        for i in range(10):
            ...
            search_manager.index_message(
                i + 1,
                f"hello{i}",
                {"author_id": 1, "conversation_id": 1, "created_at": 1000},
            )
...
class TestSearchMessageFeatures:
    ...
    def test_search_with_date_range(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'old message', 1000, 1000, 'text'), (2, 1, 1, 'new message', 5000, 5000, 'text')"
        )

        search_manager.index_message(
            1, "old message", {"author_id": 1, "conversation_id": 1, "created_at": 1000}
        )
        search_manager.index_message(
            2, "new message", {"author_id": 1, "conversation_id": 1, "created_at": 5000}
        )
    ...
    def test_search_with_attachments_only(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'with attachment', 1000, 1000, 'text')"
        )
        test_db.execute(
            "INSERT INTO msg_attachments (id, message_id, filename, content_type, size, url, created_at) VALUES (1, 1, 'file.txt', 'text/plain', 100, 'url', 1000)"
        )
    ...
    def test_search_mentions_only(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 2, 'hey <@1>', 1000, 1000, 'text')"
        )

        search_manager.index_message(
            1, "hey <@1>", {"author_id": 2, "conversation_id": 1, "created_at": 1000}
        )
    ...
    def test_search_partial_match(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'testing messages', 1000, 1000, 'text')"
        )
...
class TestSearchUserFeatures:
    ...
    def test_search_users_by_username(self, search_manager, test_db):
        ...
        test_db.execute("DELETE FROM auth_users")
        test_db.execute(
            "INSERT INTO auth_users (id, username, account_type, password_hash, permissions, created_at, updated_at, email_verified) VALUES (1010, 'john_doe', 'user', 'hash', '{}', 1000, 1000, 1)"
        )
    ...
    def test_search_users_partial(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO auth_users (id, username, account_type, password_hash, permissions, created_at, updated_at, email_verified) VALUES (11, 'developer123', 'user', 'hash', '{}', 1000, 1000, 1)"
        )
    ...
    def test_search_users_exclude_bots(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO auth_users (id, username, account_type, password_hash, permissions, created_at, updated_at, email_verified) VALUES (12, 'botuser', 'bot', 'hash', '{}', 1000, 1000, 1)"
        )

        search_manager.index_user(12, "botuser", is_bot=True)

        search_manager.search_users(1, "bot")
        assert True
    ...
    def test_search_users_limit(self, search_manager, test_db):
        ...
        for i in range(10):
            test_db.execute(
                "INSERT INTO auth_users (id, username, account_type, password_hash, permissions, created_at, updated_at, email_verified) VALUES (?, ?, 'user', 'hash', '{}', 1000, 1000, 1)",
                (100 + i + 1, f"user{i}"),
            )
...
class TestSearchServerFeatures:
    ...
    def test_search_servers_by_name(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO srv_servers (id, name, owner_id, created_at, updated_at) VALUES (1, 'Gaming Community', 1, 1000, 1000)"
        )
        test_db.execute(
            "INSERT INTO srv_members (id, server_id, user_id, joined_at, updated_at) VALUES (1, 1, 1, 1000, 1000)"
        )

        search_manager.index_server(
            1, "Gaming Community", member_count=1, is_public=True
        )
    ...
    def test_search_servers_member_only(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO srv_servers (id, name, owner_id, created_at, updated_at) VALUES (1, 'Private Server', 2, 1000, 1000)"
        )

        results = search_manager.search_servers(1, "private")
        assert len(results) == 0

    @pytest.mark.skip("Description column removed in migration 028")
    def test_search_servers_with_description(self, search_manager, test_db):
        """Search servers includes description."""
        test_db.execute(
            "INSERT INTO srv_servers (id, name, description, owner_id, created_at, updated_at) VALUES (1, 'Server', 'gaming community', 1, 1000, 1000)"
        )
        test_db.execute(
            "INSERT INTO srv_members (id, server_id, user_id, joined_at, updated_at) VALUES (1, 1, 1, 1000, 1000)"
        )
        ...
        search_manager.index_server(
            1, "Server", description="gaming community", member_count=1, is_public=True
        )
...
class TestSearchIndexing:
    ...
    def test_index_message(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'indexable content', 1000, 1000, 'text')"
        )
    ...
    def test_remove_from_index(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'to be deleted', 1000, 1000, 'text')"
        )
    ...
    def test_reindex_all(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'message one', 1000, 1000, 'text'), (2, 1, 1, 'message two', 1000, 1000, 'text')"
        )
...
class TestSearchPermissions:
    ...
    def test_search_private_conversation(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_participants (id, conversation_id, user_id, role, joined_at) VALUES (1, 1, 2, 'member', 1000)"
        )
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 2, 'private message', 1000, 1000, 'text')"
        )
    ...
    def test_search_server_without_membership(self, search_manager, test_db):
        ...
        # Create user first for foreign key constraint
        test_db.execute(
            "INSERT INTO auth_users (id, username, account_type, password_hash, permissions, created_at, updated_at) VALUES (2, 'user2', 'user', 'hash', '{}', 1000, 1000)"
        )
        test_db.execute(
            "INSERT INTO srv_servers (id, name, owner_id, created_at, updated_at) VALUES (1, 'Private Server', 2, 1000, 1000)"
        )
        test_db.execute(
            "INSERT INTO srv_channels (id, server_id, name, channel_type, created_at, updated_at, position) VALUES (1, 1, 'general', 'text', 1000, 1000, 0)"
        )
...
class TestSearchSorting:
    ...
    def test_search_sort_by_relevance(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'test test test', 1000, 1000, 'text'), (2, 1, 1, 'test message', 2000, 2000, 'text')"
        )
        ...
        search_manager.index_message(
            2,
            "test message",
            {"author_id": 1, "conversation_id": 1, "created_at": 2000},
        )
    ...
    def test_search_sort_by_date(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'old test', 1000, 1000, 'text'), (2, 1, 1, 'new test', 5000, 5000, 'text')"
        )

        search_manager.index_message(
            1, "old test", {"author_id": 1, "conversation_id": 1, "created_at": 1000}
        )
        search_manager.index_message(
            2, "new test", {"author_id": 1, "conversation_id": 1, "created_at": 5000}
        )
...
class TestSearchHighlighting:
    ...
    def test_highlight_search_terms(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'this is a test message', 1000, 1000, 'text')"
        )
...
class TestSearchPerformance:
    ...
    def test_search_with_cache(self, search_manager, test_db):
        ...
        test_db.execute(
            "INSERT INTO msg_messages (id, conversation_id, author_id, content, created_at, updated_at, message_type) VALUES (1, 1, 1, 'cached message', 1000, 1000, 'text')"
        )
