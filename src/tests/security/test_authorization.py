...
class TestAuthorizationChecks:
    ...
    def test_user_cannot_create_group_with_other_user_as_owner(self, modules, user_pool):
    ...
    def test_user_cannot_escalate_own_permissions(self, modules, user_pool):
        ...
        assert "admin.*" not in user_obj.permissions or not user_obj.permissions.get("admin.*")
