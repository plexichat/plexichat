...
class TestWebhookErrors:
    ...
    def test_webhook_limit_per_server(self, webhook_manager, test_db, monkeypatch):
        ...
        test_db.execute("INSERT INTO srv_servers (id, name, owner_id, created_at, updated_at) VALUES (1, 'Test', 1, 1000, 1000)")
        test_db.execute("INSERT INTO srv_channels (id, server_id, name, channel_type, created_at, updated_at, position) VALUES (1, 1, 'ch1', 'text', 1000, 1000, 0), (2, 1, 'ch2', 'text', 1000, 1000, 1)")
    ...
    def test_move_webhook_different_server(self, webhook_manager, test_db):
        ...
        test_db.execute("INSERT INTO srv_servers (id, name, owner_id, created_at, updated_at) VALUES (1, 'S1', 1, 1000, 1000), (2, 'S2', 1, 1000, 1000)")
        test_db.execute("INSERT INTO srv_channels (id, server_id, name, channel_type, created_at, updated_at, position) VALUES (1, 1, 'ch1', 'text', 1000, 1000, 0), (2, 2, 'ch2', 'text', 1000, 1000, 0)")
    ...
    def test_execute_webhook_content_too_long(self, webhook_manager, test_db, monkeypatch):
    ...
    def test_execute_with_username_override(self, webhook_manager, test_db):
        ...
        result = webhook_manager.execute_webhook(
            webhook.token,
            {"content": "test", "username": "Custom Name"}
        )
